    ...
    <div class="uk-grid uk-flex uk-flex-center">
      ...
      <div class="uk-grid uk-text-center uk-width-1-1">
        ...
        <div class="uk-tile bg-primary uk-padding-large">
          <p>You currently do not have any capital assigned towards any remote trader. Please click on Assign Remote
            trader below to assign one or more traders to your capital.</p>
